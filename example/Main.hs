...
instance Memorizable City where
  ...
  recall =
    unLengthPrefix255 City (  twoFields -- geoNameId    -- name
                           &. twoFields -- asciiName    -- feature class
                           &. twoFields -- feature code -- country code
                           &. twoFields -- population   -- elevation
                           &. twoFields -- timezone     -- alternate names
                           &. twoFields -- lat          -- lng
                           )
